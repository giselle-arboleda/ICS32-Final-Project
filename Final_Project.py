...
class Body(tk.Frame):
    def __init__(self, root, select_callback=None):
        ...
        # messages that are contained in the list _msgs
        self._recipients = []
        self._msgs = []
    ...
    Calls _insert_recipient_tree and passes the index and recipient object in _recipients. 
    """
...
class MainApp(tk.Frame):
    ...
    def _draw(self):
        ...
        #Creating a "Flourish" feature --> Christmas Mode
